        ...
        <div id="menuIcon">
            <button id="menuIconButton" onClick={clickMenuIcon}>
                <svg id="morph_svg" width="40" height="40" viewBox="0 0 40 40" fill="none" >
                    ...
                    <path id="menuIconColor1" className={showDropDownMenu ? "morphing" : ""} d="M3 6H37V12H3V6Z"/>
                    <path id="menuIconColor2" className={showDropDownMenu ? "morphing" : ""} d="M3 17H37V23H3V17Z"/>
                    <path id="menuIconColor3" className={showDropDownMenu ? "morphing" : ""} d="M3 28H37V34H3V28Z"/>
                </svg>
